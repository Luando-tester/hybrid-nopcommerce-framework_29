...
public class Level_28_Cloud_BrowserStack extends BaseTest {
    ...
    @BeforeClass
    public void beforeClass(String environment,String osName, String osVer, String browserName, String browserVer) {
        ConfigFactory.setProperty("environment",environment);
        environmentConfig = ConfigFactory.create(EnvironmentConfig.class);
        driver = getBroswerDriverBrowserStack(environmentConfig.getAppUrl(),osName,osVer,browserName,browserVer);

...
public class Level_28_Cloud_DeviceFarm extends BaseTest {
    WebDriver driver;
    Select select;
    ...
    public void beforeClass(String environment,String platformNmae, String browserName, String browserVer) {
        ...
        driver = getBroswerDriveDeviceFarm(environmentConfig.getAppUrl(),platformNmae,browserName,browserVer);

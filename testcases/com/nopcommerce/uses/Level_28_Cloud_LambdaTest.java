...
public class Level_28_Cloud_LambdaTest extends BaseTest {
    WebDriver driver;
    Select select;
    ...
    public void beforeClass(String environment,String platformNmae, String browserName, String browserVer) {
        ...
        driver = getBroswerDriverLambdaTets(environmentConfig.getAppUrl(),platformNmae,browserName,browserVer);

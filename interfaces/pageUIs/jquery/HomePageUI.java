...
public class HomePageUI {
    ...
    public static final String DYNAMIC_DELETE_BUTTON_BY_COUNTRY_NAME_1 = "XPATH=//div[@class='qgrd-header-text'" + "and text()='%s']/parent::div/following-sibling::input";
    ...
    public static final String DYNAMIC_PRECEDING_SIBLING_COLUMN_NUMBER_2 = "XPATH=//th[text()='%s']/preceding-sibling::th";
    public static final String ALL_VALUE_BY_COLUMN_INDEX = "XPATH=//div[text()='%s']/ancestor::th/preceding-sibling::th";
